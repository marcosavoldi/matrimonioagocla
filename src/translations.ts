...
export const translations: Record<Language, Translation> = {
    ...
    sq: {
        ...
        scrollDown: '',
        introText: 'Ndërsa presim ditën tonë të madhe, kemi krijuar këtë faqe ku mund të gjeni të gjithë informacionin e nevojshëm.',
        confirmBy: 'Ju lutemi të konfirmoni praninë tuaj deri më 24 maj duke plotësuar formularin në fund të faqes, në mënyrë që ta organizojmë më mirë ditën.',
        importantTitle: 'Informacion i Rëndësishëm ⚠️',
        noKidsPolicy: 'Fëmijët tuaj janë shumë të rëndësishëm për ne, por nuk do të ketë argëtim për të vegjlit në këtë ditë. Nëse është e mundur, ju ftojmë t\'i lini ata me gjyshërit, dadot ose miqtë, në mënyrë që të relaksoheni dhe të shijoni festën pa shqetësime... ndërsa ngrini dolli me ne!',
        giftTitle: 'Dhurata 🎁',
        giftText: 'Ndërsa zemrat tona janë tashmë të mbushura me dashuri... portofolet tona (që qajnë) shpresojnë për një përforcim të vogël për ditën e madhe dhe më tej!',
        ibanLabel: 'IBAN',
